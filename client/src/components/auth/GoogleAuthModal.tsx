                ...
                <div className="relative z-10 p-5 sm:p-6">
                  ...
                  {mode === 'signup' ? (
                    ...
                    >
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Email or Phone Number <span className="text-red-500">*</span></label>
                        <input 
                          type="text" 
                          required
                          value={contact}
                        ...
                        {isContactInvalid && (
                          <p className="text-xs mt-1 text-red-500">
                            {isPhoneNumber ? "Phone number must contain exactly 10 digits." : "Email must contain an '@' symbol."}
                          </p>
                        )}
                      </div>
                      <div>
