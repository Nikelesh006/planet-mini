        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 bg-[#F1F9F1] rounded-full flex items-center justify-center mb-4 border border-[#E4F4E4]">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 bg-[#FFF9F1] rounded-full flex items-center justify-center mb-4 border border-[#FEF2E4]">
                <Crown className="w-10 h-10 text-[#D97706]" />
              </div>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 bg-[#EEF4FB] rounded-full flex items-center justify-center mb-4 border border-[#DCE8F6]">
                <CloudRain className="w-10 h-10 text-[#3182CE]" />
              </div>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 bg-[#FFF1F1] rounded-full flex items-center justify-center mb-4 border border-[#FFE4E4]">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 bg-[#F2FAF2] rounded-full flex items-center justify-center mb-4 border border-[#E6F4E6]">
